...
## e depois fazemos algumas alterações referente ao nome das colunas, onde passamos a variável "names",
## no qual removemos caractéres especiais e espaços em branco
